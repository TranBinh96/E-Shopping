...
<!-- Bootstrap Core CSS -->
<link href='<c:out value="/resources/quantri/css/bootstrap.min.css" />' rel='stylesheet' type='text/css' />
<!-- Custom CSS -->
<link href='<c:out value="/resources/quantri/css/style.css" />' rel='stylesheet' type='text/css' />
<link rel="stylesheet" href='<c:out value="/resources/quantri/css/morris.css" />' type="text/css"/>
<!-- Graph CSS -->
<link href='<c:out value="/resources/quantri/css/font-awesome.css" />' rel="stylesheet">
<!-- jQuery -->
<script src='<c:out value="/resources/quantri/js/jquery-2.1.4.min.js" />' ></script>
<!-- //jQuery -->
<link href='//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'/>
<link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
<!-- lined-icons -->
<link rel="stylesheet" href='<c:out value="/resources/quantri/css/icon-font.min.css" />' type='text/css' />
<!-- //lined-icons -->
</head> 
<body>
             ...
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
								<h1><a href="admin.jsp">Pooled</a></h1>
							</div>
...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="admin.jsp">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
<!--four-grids here-->
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href="admin.jsp"><i class="fa fa-tachometer"></i> <span>Trang Chủ</span><div class="clearfix"></div></a></li>
										
										
										 <li id="menu-academico" ><a href="/themsanpham"><i class="fa fa-envelope nav_icon"></i><span>Thêm Sản Phẩm</span><div class="clearfix"></div></a></li>
...
<!--js -->
<script src='<c:out value="/resources/quantri/js/jquery.nicescroll.js" />'></script>
<script src='<c:out value="/resources/quantri/js/scripts.js" />'></script>
<!-- Bootstrap Core JavaScript -->
   <script src='<c:out value="/resources/quantri/js/bootstrap.min.js" /> ' ></script>
   <!-- /Bootstrap Core JavaScript -->	   
<!-- morris JavaScript -->	
<script src='<c:out value="/resources/quantri/js/raphael-min.js" />'></script>
<script src='<c:out value="/resources/quantri/js/morris.js" />' ></script>
<script>
	$(document).ready(function() {
